...
let dia_create_cpp_variable (i : int) = Printf.sprintf "v%d" i
  ...
  [
    {
      ...
      generate_code =
        (fun node var_index ->
          ...
          let a2 = List.nth node.parameters 1 in
...
let functions =
  functions_io @ functions_arithmetic @ functions_logic @ functions_comparison
